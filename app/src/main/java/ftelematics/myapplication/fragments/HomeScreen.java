...
public class HomeScreen extends Fragment implements HomeCallBacks {
    ...
    void start()
    {
        homeScreenViewModel.getMovies().observe(getActivity(), new Observer<ArrayList<MovieViewModel>>() {
            @Override
